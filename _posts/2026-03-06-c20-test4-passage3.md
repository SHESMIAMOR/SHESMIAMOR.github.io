...
| Description | Answer |
|---|---|
| an example of how one predator has been protected by the introduction of livestock guard dogs | D |
| an optimistic suggestion about the possible positive developments in the use of livestock guard dogs | G |
| a description of how the methods used by livestock guard dogs help to keep predators away | C |
| claims by different academics that the use of livestock guard dogs is a successful way of protecting farmers’ herds | F |
| a reference to how livestock guard dogs gain their skills | B |
